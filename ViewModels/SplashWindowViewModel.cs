...
namespace YukaLister.ViewModels
{
	public class SplashWindowViewModel : ViewModel
	{
		...
		public void Initialize()
		{
			...
			aMainWindowViewModel.SplashWindowVm = this;
			aMainWindowViewModel.YukaLister = new YukaListerModel(aMainWindowViewModel);

			// メインウィンドウ表示
			Messenger.Raise(new TransitionMessage(aMainWindowViewModel, "OpenMainWindow"));
		}
	}
	// public class SplashWindowViewModel ___END___
}
